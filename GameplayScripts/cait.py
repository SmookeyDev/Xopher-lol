    ...
    def winstealer_load_cfg(cfg):
        global use_q_in_combo, use_w_on_immobile, use_r_in_combo, use_e_in_combo, use_w_in_combo, use_q_aa
        ...
        use_q_aa = cfg.get_bool ("use_q_aa", True)
    ...
    def winstealer_save_cfg(cfg):
        ...
        cfg.set_bool ("use_q_aa", use_q_aa)
    ...
    def winstealer_draw_settings(game, ui):
        ...
        global combo_key, move_in_combo
        global use_e_evade
        ui.text("Made with <3 by github-1nteg3r")
        ...
        if ui.treenode ("Setting [Q]"):
            ...
            use_q_aa = ui.checkbox ("Use Q only if out of AA Range", use_q_aa)
            ui.treepop ()
    ...
    def QAA(game):
        ...
        w_spell = getSkill (game, 'W')
        r_spell = getSkill (game, 'R')
        if use_q_aa and IsReady (game, q_spell) and game.player.mana > 90:
            target = GetBestTargetsInRange (game, q['Range'])
